...
import 'package:quran_app/features/quranDetails/logic/translation/translations/muyassar.dart';
import 'package:quran_app/features/quranDetails/logic/translation/translations/sahih_english.dart';
...
Future<String> getVerseTranslation(
  ...
  return verse +
      (verseEndSymbol
          ? q.getVerseEndSymbol(verseNumber, arabicNumeral: true)
          : "");
}
